...
internal static class MachOMagicNumbers
{
    public static readonly IReadOnlyDictionary<byte[], (Bitness bitness, Endianness Endianess, bool IsFat)> NonFat =
        new Dictionary<byte[], (Bitness bitness, Endianness Endianess, bool IsFat)>(SequentialCollectionComparer<byte>.Instance)
        {
        ...
        }.ToImmutableDictionary(SequentialCollectionComparer<byte>.Instance);
